...
const UsdtSvg = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#26a17b"/><text x="12" y="16" textAnchor="middle" fontSize="12" fill="#fff" fontWeight="bold">T</text></svg>
);
      ...
      <div className="sellcoins-modal">
        ...
        <div className="sellcoins-field-group">
          ...
          <div className="sellcoins-input-row">
            ...
            <input className="sellcoins-input" type="text" value={sellAmount} onChange={e => setSellAmount(e.target.value)} />
          </div>
        </div>
        <div className="sellcoins-field-group">
          ...
          <div className="sellcoins-input-row">
            ...
            <input className="sellcoins-input" type="text" value={receiveAmount} onChange={e => setReceiveAmount(e.target.value)} />
          </div>
        </div>
        <div className="sellcoins-info">
          <span className="sellcoins-info-label">Info</span>
          <span className="sellcoins-info-detail">• Exchange Rate: 1 BTC = 43,300 USDT<br/>• Estimated Fee: ~0.001 BTC</span>
        </div>
        <button className="sellcoins-btn">BUY COINS</button>
      </div>
    </div>
  );
};
